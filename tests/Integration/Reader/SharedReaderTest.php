...
namespace JardisTools\DbSchema\Tests\Integration\Reader;

use JardisTools\DbSchema\Reader\MySqlReader;
use JardisTools\DbSchema\Reader\PostgresReader;
use JardisTools\DbSchema\Reader\SqLiteReader;
...
class SharedReaderTest extends TestCase
{
    ...
    public function testMySqlConstructor(): void
    {
        ...
        $this->assertInstanceOf(DbSchemaReaderInterface::class, $repository);
    }
     ...
     */
    public function testTables(string $driverName, PDO $pdo, callable $schemaCreator, DbSchemaReaderInterface $repository): void
    {
        $schemaCreator($pdo);
    ...
    /**
     * @dataProvider databaseProvider
     * @covers \JardisTools\DbSchema\Reader\MySqlReader::columns
     * @covers \JardisTools\DbSchema\Reader\PostgresReader::columns
     * @covers \JardisTools\DbSchema\Reader\SqLiteReader::columns
     */
    public function testColumnsUsers(string $driverName, PDO $pdo, callable $schemaCreator, DbSchemaReaderInterface $repository): void
    {
        $schemaCreator($pdo);
     ...
     * @covers \JardisTools\DbSchema\Reader\SqLiteReader::columns
     */
    public function testColumnsOrders(string $driverName, PDO $pdo, callable $schemaCreator, DbSchemaReaderInterface $repository): void
    {
        $schemaCreator($pdo);
     ...
     * @covers \JardisTools\DbSchema\Reader\SqLiteReader::columns
     */
    public function testColumnsWithFieldFilter(string $driverName, PDO $pdo, callable $schemaCreator, DbSchemaReaderInterface $repository): void
    {
        $schemaCreator($pdo);
    ...
    /**
     * @dataProvider databaseProvider
     * @covers \JardisTools\DbSchema\Reader\MySqlReader::indexes
     * @covers \JardisTools\DbSchema\Reader\PostgresReader::indexes
     * @covers \JardisTools\DbSchema\Reader\SqLiteReader::indexes
     */
    public function testIndexesUsers(string $driverName, PDO $pdo, callable $schemaCreator, DbSchemaReaderInterface $repository): void
    {
        $schemaCreator($pdo);
     ...
     * @covers \JardisTools\DbSchema\Reader\SqLiteReader::indexes
     */
    public function testIndexesOrders(string $driverName, PDO $pdo, callable $schemaCreator, DbSchemaReaderInterface $repository): void
    {
        $schemaCreator($pdo);
    ...
    /**
     * @dataProvider databaseProvider
     * @covers \JardisTools\DbSchema\Reader\MySqlReader::foreignKeys
     * @covers \JardisTools\DbSchema\Reader\PostgresReader::foreignKeys
     * @covers \JardisTools\DbSchema\Reader\SqLiteReader::foreignKeys
     */
    public function testForeignKeysOrders(string $driverName, PDO $pdo, callable $schemaCreator, DbSchemaReaderInterface $repository): void
    {
        $schemaCreator($pdo);
     ...
     * @covers \JardisTools\DbSchema\Reader\SqLiteReader::foreignKeys
     */
    public function testForeignKeysUsers(string $driverName, PDO $pdo, callable $schemaCreator, DbSchemaReaderInterface $repository): void
    {
        $schemaCreator($pdo);
    ...
    /**
     * @dataProvider databaseProvider
     * @covers \JardisTools\DbSchema\Reader\MySqlReader::fieldType
     * @covers \JardisTools\DbSchema\Reader\PostgresReader::fieldType
     * @covers \JardisTools\DbSchema\Reader\SqLiteReader::fieldType
     */
    public function testFieldTypeMapping(string $driverName, PDO $pdo, callable $schemaCreator, DbSchemaReaderInterface $repository): void
    {
