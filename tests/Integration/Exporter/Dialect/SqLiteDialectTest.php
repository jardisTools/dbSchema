...
namespace JardisTools\DbSchema\Tests\Integration\Exporter\Dialect;
...
class SqLiteDialectTest extends TestCase
{
    ...
    public function testCreateForeignKeyStatementReturnsEmptyString(): void
    {
        $foreignKey = [
        ...
        // The method must return an empty string so callers can skip the statement.
        $this->assertSame('', $sql);
    }
