...
namespace JardisTools\DbSchema\Tests\Integration\Exporter\Ddl;
...
class SqlDdlExporterTest extends TestCase
{
    ...
    public function testGenerateSqLiteDdl(): void
    {
        ...
        // SQLite does not support ALTER TABLE ADD FOREIGN KEY — no FK statements in output
        $this->assertStringNotContainsString('-- Foreign key constraint', $sql);
    }
}
