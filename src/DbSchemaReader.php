...
/**
 * Handles database schema reading using various supported database drivers.
...
{
    private PDO $pdo;
    private ?DbSchemaReaderInterface $schemaReader = null;
     ...
     */
    private function schemaRepository(): DbSchemaReaderInterface
    {
